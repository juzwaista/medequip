...
class DistributorController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'valid_id' => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:5120', SafeUpload::document()],
            'business_license' => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:5120', SafeUpload::document()],
            'dti_sec' => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:5120', SafeUpload::document()],
            'bir_form' => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:5120', SafeUpload::document()],
            'fda_license' => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:5120', SafeUpload::document()],
            'prc_id' => ['required', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:5120', SafeUpload::document()],
            'authorization_letter' => ['nullable', 'file', 'mimes:pdf,jpg,jpeg,png', 'max:5120', SafeUpload::document()],
        ], [
