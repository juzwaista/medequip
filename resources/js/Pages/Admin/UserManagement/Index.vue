                    ...
                    <form @submit.prevent="submitAdmin" class="max-w-xl space-y-4">
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <select v-model="adminForm.role" required class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500 focus:border-transparent">
                                    <option value="" disabled>Select Role...</option>
                                    <option v-for="role in platformRoles" :key="role.id" :value="role.name">{{ role.name }}</option>
                                </select>
                                <p v-if="adminForm.errors.role" class="text-red-500 text-xs mt-1">{{ adminForm.errors.role }}</p>
                            </div>
                        </div>
