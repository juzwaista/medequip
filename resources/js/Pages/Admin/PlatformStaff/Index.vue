                    ...
                    <div class="bg-white rounded-xl shadow-md p-6 sticky top-24">
                        ...
                        <form @submit.prevent="submit" class="space-y-4">
                            ...
                            <button 
                                ...
                                class="w-full bg-blue-600 text-white font-semibold py-2.5 rounded-lg hover:bg-blue-700 transition disabled:opacity-50"
                            >
...
const generatePassword = () => {
    return 'MedEquip@' + Math.random().toString(36).slice(-6) + '!';
};
