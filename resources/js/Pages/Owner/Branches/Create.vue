<template>
    <OwnerLayout>
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="mb-6">
                <h1 class="text-3xl font-bold text-ink">Add New Branch</h1>
                <p class="text-ink-soft mt-2">Add a new branch location for {{ distributor.company_name }}</p>
            </div>

            <div class="bg-white rounded-card shadow-md p-6">
                <form @submit.prevent="submit" class="space-y-6">
                    <div>
                        <label class="block text-sm font-semibold text-ink mb-2">Branch Name *</label>
                        <input
