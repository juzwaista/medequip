            ...
            <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p v-if="page.props.auth?.user?.role === 'distributor'" class="text-sm text-gray-500 mt-2 max-w-xl">
                        Your earnings from completed sales appear here after fees are deducted.
                    </p>
                </div>
            </div>
...
const formatType = (type) => {
    const map = {
        'topup': 'Wallet Top-up',
        'escrow_verified': 'Sale — payment verified (held by platform)',
        'escrow_release': 'Order payout (buyer confirmed)',
