            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10">
                ...
                <div class="lg:col-span-6">
                    ...
                    <div class="mt-5 rounded-lg bg-gray-50 border border-gray-100 px-3 py-2.5 text-sm">
                        ...
                        <span v-if="product.distributor.is_suspended" class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-[10px] font-bold bg-rose-100 text-rose-800 uppercase tracking-widest">
                            Suspended
                        </span>
                    </div>
                    ...
                    <div class="mt-6 space-y-3">
                        ...
                        <div class="hidden sm:flex gap-3">
                            <button
                                type="button"
                                @click="addToCart"
                                :disabled="adding || lineAvailable <= 0 || (hasVariations && !selectedVariationId) || product.distributor.is_suspended"
                            ...
                            <button
                                type="button"
                                @click="buyNow"
                                :disabled="buyingNow || lineAvailable <= 0 || (hasVariations && !selectedVariationId) || product.distributor.is_suspended"
