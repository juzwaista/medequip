<template>
    ...
    >
        ...
        >
            ...
            <template v-for="seg in timelineSegments" :key="seg.key">
                ...
                <div
                    ...
                    :class="seg.message.is_mine ? 'justify-end pl-12' : 'justify-start pr-12'"
                >
                    <span
        ...
        <form
            class="shrink-0 p-3 border-t flex flex-row flex-nowrap items-end gap-2"
        ...
        >
            ...
            <button
                type="button"
                class="shrink-0 w-11 h-11 inline-flex items-center justify-center rounded-xl border-2 border-gray-300 bg-white text-gray-600 hover:bg-gray-50 hover:border-gray-400 disabled:opacity-50 transition"
                :disabled="sending"
                title="Attach photo"
            ...
            <button
                ...
                class="shrink-0 h-11 min-w-[4.5rem] px-4 inline-flex items-center justify-center rounded-xl bg-blue-600 text-white text-sm font-semibold hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
            >
                {{ sending ? '…' : 'Send' }}
            </button>
        </form>
