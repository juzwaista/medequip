        ...
        >
            ...
            <nav class="flex-1 overflow-y-auto py-4 px-3 space-y-1">
                ...
                <Link
                    ...
                    v-if="canDo('admin.applications.review')"
                    :class="['flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors', isActive('/admin/business-profiles') ? 'bg-blue-600 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800']"
                >
                ...
                <Link
                    href="/admin/products"
                    v-if="canDo('admin.products.view')"
                ...
                <Link 
                    href="/admin/couriers" 
                    v-if="canDo('admin.couriers.create') || isSuperAdmin"
                ...
                <Link
                    ...
                    v-if="canDo('admin.disputes.review')"
                ...
                <Link
                    ...
                    :class="['flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors', isActive('/admin/audit-logs') ? 'bg-blue-600 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800']"
                >
                ...
                <template v-if="$page.props.auth.user && $page.props.auth.user.role === 'super_admin'">
                    ...
                    <Link 
                        href="/admin/roles" 
                        :class="['flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-colors', isActive('/admin/roles') ? 'bg-indigo-600 text-white' : 'text-gray-400 hover:text-white hover:bg-gray-800']"
                    >
